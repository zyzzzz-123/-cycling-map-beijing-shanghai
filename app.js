...
const plan = [
  ...
  },
  {
    ...
    difficulty: "最高",
    type: "ride",
    roads: "济宁 → 鱼台 → 微山湖西 → 韩庄 → 台儿庄。优先 S318/S104/韩庄运河并行路，避开邹城-滕州-薛城的 G104 丘陵线。",
    note: "这是全程最硬日。保留枣庄打卡，但不建议再进枣庄主城区。",
    riskText: "距离长、后半段起伏增加，韩庄到台儿庄有货运交通；逆风或身体差时应拆成两天。",
    lodging: "台儿庄古城外缘或台儿庄城区。住宿密、补给好，又完成了经过枣庄的目标。",
    food: "台儿庄/枣庄可吃辣子鸡、菜煎饼、羊肉汤、黄花牛肉面；D6 后胃口可能差，先补流食和盐分。",
    shortOption: "少骑：住鱼台、微山湖西或韩庄，约 55-105km；把 D6 拆成两天是最合理的应急方案。",
    longOption: "多骑：到邳州西侧，约 150-165km；不建议，因为 D7 还要处理徐州外缘。",
    why: "选鱼台-微山湖西-韩庄-台儿庄，是为了走湖西和运河低地，避开邹城-滕州-薛城-枣庄主城的丘陵和 G104 重车线。替代线进枣庄市中心打卡更明确，但对你当前体重和连续长途状态不划算。",
    points: [
      ["济宁", 116.5872, 35.4149],
      ["鱼台", 116.65, 35.0],
      ["微山湖西", 116.89, 34.82],
      ["韩庄", 117.338, 34.75],
      ["枣庄台儿庄", 117.734, 34.563],
    ],
  },
  {
    day: "D7",
    ...
    difficulty: "高",
    type: "ride",
    roads: "台儿庄 → 邳州 → 徐州外缘 → 睢宁。优先 G310/G311 外缘连接线、S251/S270 类省道，绕开徐州市中心。",
    note: "徐州周边宁可绕，不要被带上高架或快速路。",
    riskText: "物流车、施工绕行、高架匝道是主要风险；城市外缘比市中心更适合长途穿越。",
    lodging: "睢宁县城。住在城内比住徐州外缘更安静，第二天接宿迁/淮安顺。",
    food: "徐州、睢宁一带可吃地锅鸡、把子肉、羊肉汤、烙馍卷菜；当天过徐州外缘，别把晚餐拖太晚。",
    shortOption: "少骑：住邳州或徐州东外缘，约 55-95km；第二天补到宿迁/泗阳。",
    longOption: "多骑：到宿迁，约 155-170km；只有状态非常好且徐州绕行顺利时考虑。",
    why: "台儿庄到睢宁选择徐州外缘，是为了避开徐州市中心和高架系统。替代线进徐州市区住宿更方便，但红绿灯、匝道和大车混行更消耗注意力。",
    points: [
      ["枣庄台儿庄", 117.734, 34.563],
      ["邳州", 117.9639, 34.3147],
